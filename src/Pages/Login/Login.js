  ...
  return (
    <div className="login-page d-flex justify-content-center align-items-center">
      <div className="container d-md-flex justify-content-around">
        <div className="p-4 p-md-4 shadow-lg mb-1 m-md-5 login-form bg-white rounded
      col-md-4">
        <form className="">
        ...
        <button className="btn w-100 border border-primary text-primary"><i class="fa-brands fa-google"></i> Continue With Google</button>
        </div>
