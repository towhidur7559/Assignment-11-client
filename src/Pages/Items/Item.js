...
const Item = ({ data }) => {
  const { img, name, price, description, quantity, supplier } = data;
  return (
    <div className="col">
      <div className="card h-100 border-0 shadow-lg hover-effect">
        ...
        <div className="card-body py-1">
          ...
          <p className="card-text text-justify"><small>{description}</small></p>
          <div>
        ...
        <div className="card-footer bg-white border-top-0 pb-4">
          <button className="btn btn-info mx-auto w-100">Update</button>
        </div>
      </div>
    </div>
  );
